...
export default function WeekScreen() {
  const { getWeekTasks, toggleTaskDone, deleteTask, addTask } = useContext(TaskContext);
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.header}>Tâches de cette semaine</Text>
      ...
      <FlatList
        ...
        ListEmptyComponent={<Text style={styles.empty}>Aucune tâche cette semaine</Text>}
      />
