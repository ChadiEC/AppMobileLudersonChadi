...
export default function AllTask() {
  const { tasks, deleteTask, toggleTaskDone, addTask } = useContext(TaskContext);
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.header}>Toutes les tâches</Text>
      ...
      <FlatList
        ...
        renderItem={({ item }) => (
          ...
          >
            <TouchableOpacity
              style={[styles.taskBox, item.isDone && { backgroundColor: '#d3ffd3' }]}
